...
const EditModal = ({
  ...
  const [oldcomment, setoldComment] = useState(comment);
      ...
      <div className="relative p-4 w-full max-w-2xl ">
        <div className="bg-neutral-primary-soft  rounded-base  p-4 md:p-6 bg-white rounded-lg shadow-lg">
          ...
          <div className="flex items-center justify-between   pb-4 md:pb-5">
            <h3 className="text-lg font-medium text-heading">Edit Comment</h3>
          ...
          <div className="py-4 md:py-6">
            <input
              type="text"
              value={oldcomment}
              className="w-full p-2 border rounded shadow-sm focus:outline-none focus:border-brand focus:ring-1 focus:ring-brand"
